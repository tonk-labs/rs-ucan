...
impl<T: Serialize + for<'a> Deserialize<'a>> Codec<T> for Encoding {
    ...
    fn encode_payload<W: Write>(
        ...
        match self {
            ...
            #[cfg(feature = "jwt")]
            Encoding::Jwt => unimplemented!("JWT encoding is not yet implemented"),

            #[cfg(feature = "eip191")]
            Encoding::Eip191 => unimplemented!("EIP-191 encoding is not yet implemented"),
        }
    }
    ...
    fn decode_payload<R: BufRead>(&self, reader: &mut R) -> Result<T, Self::DecodingError> {
        match self {
            ...
            #[cfg(feature = "jwt")]
            Encoding::Jwt => unimplemented!("JWT decoding is not yet implemented"),

            #[cfg(feature = "eip191")]
            Encoding::Eip191 => unimplemented!("EIP-191 decoding is not yet implemented"),
        }
    }
}
